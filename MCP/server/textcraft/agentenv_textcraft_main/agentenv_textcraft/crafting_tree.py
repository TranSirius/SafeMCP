...
class CraftingTree:
    ...
    def __init__(self, minecraft_dir):
        ...
        if not os.path.isdir(minecraft_dir):
            minecraft_dir = "/root/your_user_name/MCP-A2A/MCP/server/textcraft/agentenv_textcraft_main/agentenv_textcraft/"
...
def main():
    tree = CraftingTree(minecraft_dir="/root/your_user_name/MCP-A2A/MCP/server/textcraft/agentenv_textcraft_main/agentenv_textcraft/")
