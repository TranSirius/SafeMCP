...
class EnhancedMCPClient:
    def __init__(self):
        ...
        self.server_paths = {
            ...
            "webshop": "/root/your_user_name/MCP-A2A/MCP/server/webshop/webshop.py",
            "textcraft": "/root/your_user_name/MCP-A2A/MCP/server/textcraft/textcraft.py",
            "movie": "/root/your_user_name/MCP-A2A/MCP/server/tool/movie.py",
            "academia": "/root/your_user_name/MCP-A2A/MCP/server/tool/academia.py",
            "sheet": "/root/your_user_name/MCP-A2A/MCP/server/tool/sheet.py",
            "todo": "/root/your_user_name/MCP-A2A/MCP/server/tool/todo.py",
            "weather_env": "/root/your_user_name/MCP-A2A/MCP/server/tool/weather.py",
            "alf_world": "/root/your_user_name/MCP-A2A/MCP/server/alfworld/alf_world.py",
            "baby_ai": "/root/your_user_name/MCP-A2A/MCP/server/babyai/babyai.py",
            "science_world": "/root/your_user_name/MCP-A2A/MCP/server/sciworld/sciworld.py",
            "webarena": "/root/your_user_name/MCP-A2A/MCP/server/webarena/webarena.py"
        }
